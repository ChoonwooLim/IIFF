  ...
  return (
    <>
      ...
      <section id="what-is-iiff" className="relative overflow-hidden scroll-mt-24">
        <img src={images.whatIsIiff} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
      ...
      <section id="why-participate" className="relative overflow-hidden scroll-mt-24">
        <img src={images.whyParticipate} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
        <div className="absolute inset-0 bg-[var(--bg)]/90" />
        <div className="relative z-10">
          <SectionWrapper>
            <FadeUp>
      ...
      <section id="vision" className="relative overflow-hidden scroll-mt-24">
        <img src={images.vision} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
        <div className="absolute inset-0 bg-[var(--bg)]/90" />
        <div className="relative z-10">
          <SectionWrapper>
            <FadeUp>
      ...
      <section id="simulation" className="relative overflow-hidden scroll-mt-24">
        <img src={images.simulation} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
        <div className="absolute inset-0 bg-[var(--bg)]/90" />
        <div className="relative z-10">
          <SectionWrapper alt>
            <FadeUp>
      ...
      <section id="strategy" className="relative overflow-hidden scroll-mt-24">
        <img src={images.strategy} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
        <div className="absolute inset-0 bg-[var(--bg)]/90" />
        <div className="relative z-10">
          <SectionWrapper alt>
            <FadeUp>
      ...
      <section id="roadmap" className="relative overflow-hidden scroll-mt-24">
        <img src={images.roadmap} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
        <div className="absolute inset-0 bg-[var(--bg)]/90" />
        <div className="relative z-10">
          <SectionWrapper alt>
            <FadeUp>
      ...
      <section id="biff" className="relative overflow-hidden scroll-mt-24">
        <img src={images.biff} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
        <div className="absolute inset-0 bg-[var(--bg)]/90" />
        <div className="relative z-10">
          <SectionWrapper>
            <FadeUp>
      ...
      <section id="budget" className="relative overflow-hidden scroll-mt-24">
        <img src={images.budget} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
        <div className="absolute inset-0 bg-[var(--bg)]/90" />
        <div className="relative z-10">
          <SectionWrapper alt>
            <FadeUp>
      ...
      <section id="seedmoney" className="relative overflow-hidden scroll-mt-24">
        <img src={images.sponsorship} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
        <div className="absolute inset-0 bg-[var(--bg)]/90" />
        <div className="relative z-10">
          <SectionWrapper alt>
            <FadeUp>
      ...
      <section id="marketing" className="relative overflow-hidden scroll-mt-24">
        <img src={images.marketing} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
        <div className="absolute inset-0 bg-[var(--bg)]/90" />
        <div className="relative z-10">
          <SectionWrapper alt>
            <FadeUp>
      ...
      <section id="political" className="relative overflow-hidden scroll-mt-24">
        <img src={images.governance} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
        <div className="absolute inset-0 bg-[var(--bg)]/90" />
        <div className="relative z-10">
          <SectionWrapper>
            <FadeUp>
      ...
      <section id="personnel" className="relative overflow-hidden scroll-mt-24">
        <img src={images.organization} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.06]" loading="lazy" />
        <div className="absolute inset-0 bg-[var(--bg)]/90" />
        <div className="relative z-10">
          <SectionWrapper alt>
            <FadeUp>
